...
var _posts = require('./campp/posts');
...
var Steem = function (_EventEmitter) {
    ...
    function Steem() {
        ...
        _this.Post = new _posts2.default(options);

        _methods2.default.forEach(function (method) {
            if (method.api === 'campp_api') return;
        ...
        _this.getStateAsync = _this.Post.getStateAsync;
        _this.getDiscussionsByTrendingAsync = _this.Post.getDiscussionsByTrendingAsync;
        _this.getTopAuthorAsync = _this.Post.getTopAuthorAsync;
        return _this;
    }
